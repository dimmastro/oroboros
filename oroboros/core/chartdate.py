...
class ChartDate(ChartFile):
	...
	def _calc_julday(self):
		...
		if self.calendar in ('gregorian', None):
			...
			isvalid, jd, dt = swe.date_conversion(utc_dt.year, utc_dt.month, utc_dt.day, hour)
		elif calendar == 'julian':
			# jd = swe.date_conversion(utc_dt.year, utc_dt.month, utc_dt.day, hour, 'j')
			isvalid, jd, dt = swe.date_conversion(utc_dt.year, utc_dt.month, utc_dt.day, hour, 'j')
		self._julday = jd # further reading
		return jd
