...
def createActions(self):
	...
	# New Chart
	self.actionNewMultiChart = PyQt5.QtWidgets.QAction(
	...
	self.actionNewMultiChart.triggered.connect(self.newMultiChartEvent)

	# Here-Now Chart
	self.actionHereNowMultiChart = PyQt5.QtWidgets.QAction(
	...
	self.actionHereNowMultiChart.triggered.connect(self.hereNowMultiChartEvent)

	# Open chart
	self.actionOpenMultiChart = PyQt5.QtWidgets.QAction(
	...
	self.actionOpenMultiChart.triggered.connect(self.openMultiChartEvent)

	# Open Astrolog32 file
	self.actionOpenMultiChartA32 = PyQt5.QtWidgets.QAction(
	...
	self.actionOpenMultiChartA32.triggered.connect(self.openMultiChartA32Event)

	# Open Skylendar chart
	self.actionOpenMultiChartSkif = PyQt5.QtWidgets.QAction(
	...
	self.actionOpenMultiChartSkif.triggered.connect(self.openMultiChartSkifEvent)

	# Custom chart
	self.actionCustomMultiChart = PyQt5.QtWidgets.QAction(
	...
	self.actionCustomMultiChart.triggered.connect(self.customMultiChartEvent)

	# Close chart
	self.actionCloseMultiChart = PyQt5.QtWidgets.QAction(
	...
	self.actionCloseMultiChart.triggered.connect(self.closeMultiChartEvent)

	# Save image
	self.actionSaveImage = PyQt5.QtWidgets.QAction(
	...
	# 	self.saveImageEvent)
	self.actionSaveImage.triggered.connect(self.saveImageEvent)

	# Quit Oroboros
	self.actionExit = PyQt5.QtWidgets.QAction(
	...
	# Edit settings
	self.actionSettings = PyQt5.QtWidgets.QAction(
	...
	self.actionSettings.triggered.connect(self.editSettingsEvent)

	# Filters manager
	self.actionFilters = PyQt5.QtWidgets.QAction(
	...
	self.actionFilters.triggered.connect(self.editSettingsEvent)


	# Planets filters manager
	self.actionPlanetsFilters = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionPlanetsFilters.triggered.connect(self.managePlanetsFiltersEvent)

	# Aspects filters manager
	self.actionAspectsFilters = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionAspectsFilters.triggered.connect(self.manageAspectsFiltersEvent)

	# Orbs filters manager
	self.actionOrbsFilters = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionOrbsFilters.triggered.connect(self.manageOrbsFiltersEvent)

	# Aspects restrictions manager
	self.actionAspectsRestrictions = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionAspectsRestrictions.triggered.connect(self.manageAspectsRestrictionsEvent)

	# Orbs restrictions manager
	self.actionOrbsRestrictions = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionOrbsRestrictions.triggered.connect(self.manageOrbsRestrictionsEvent)

	# Midpoints filters manager
	self.actionMidPointsFilters = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-execute.png')),
	...
	self.actionMidPointsFilters.triggered.connect(self.manageMidPointsFiltersEvent)

	# ### sub charts actions ###
	
	# open chart 1
	self.actionOpenChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionOpenChart1.triggered.connect(self.openChart1Event)

	# open chart 2
	self.actionOpenChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionOpenChart2.triggered.connect(self.openChart2Event)

	# hide chart 1
	self.actionHideChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionHideChart1.triggered.connect(self.hideChart1Event)

	# hide chart 2
	self.actionHideChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionHideChart2.triggered.connect(self.hideChart2Event)

	# edit chart 1
	self.actionEditChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionEditChart1.triggered.connect(self.editChart1Event)

	# edit chart 2
	self.actionEditChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionEditChart2.triggered.connect(self.editChart2Event)

	# settings chart 1
	self.actionFilterChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionFilterChart1.triggered.connect(self.filterChart1Event)

	# settings chart 2
	self.actionFilterChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionFilterChart2.triggered.connect(self.filterChart2Event)

	# save chart 1
	self.actionSaveChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionSaveChart1.triggered.connect(self.saveChart1Event)

	# save chart 2
	self.actionSaveChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionSaveChart2.triggered.connect(self.saveChart2Event)

	# save chart 1 as
	self.actionSaveChart1As = PyQt5.QtWidgets.QAction(
	...
	self.actionSaveChart1As.triggered.connect(self.saveChart1AsEvent)

	# save chart 2 as
	self.actionSaveChart2As = PyQt5.QtWidgets.QAction(
	...
	self.actionSaveChart2As.triggered.connect(self.saveChart2AsEvent)

	# close chart 1
	self.actionCloseChart1 = PyQt5.QtWidgets.QAction(
	...
	self.actionCloseChart1.triggered.connect(self.closeChart1Event)

	# close chart 2
	self.actionCloseChart2 = PyQt5.QtWidgets.QAction(
	...
	self.actionCloseChart2.triggered.connect(self.closeChart2Event)
	
	# ### comparison modes ###
	
	# switch charts
	self.actionSwitchCharts = PyQt5.QtWidgets.QAction(
	...
	self.actionSwitchCharts.triggered.connect(self.switchChartsEvent)

	# transit mode
	self.actionTransitMode = PyQt5.QtWidgets.QAction(
	...
	self.actionTransitMode.triggered.connect(self.transitModeEvent)

	# progression mode
	self.actionProgressionMode = PyQt5.QtWidgets.QAction(
	...
	self.actionProgressionMode.triggered.connect(self.progressionModeEvent)

	# direction mode
	self.actionDirectionMode = PyQt5.QtWidgets.QAction(
	...
	self.actionDirectionMode.triggered.connect(self.directionModeEvent)
	
	# ### transform ###
	
	# multiply positions
	self.actionMultiplyPos = PyQt5.QtWidgets.QAction(
	...
	self.actionMultiplyPos.triggered.connect(self.multiplyPosEvent)

	# add degrees value
	self.actionAddPos = PyQt5.QtWidgets.QAction(
	...
	# 	self.addPosEvent)
	self.actionAddPos.triggered.connect(self.addPosEvent)

	# ### merge ###
	
	# composite chart
	self.actionComposite = PyQt5.QtWidgets.QAction(
	...
	# 	self.compositeEvent)
	self.actionComposite.triggered.connect(self.compositeEvent)

	# mid-space/time chart
	self.actionMidSpaceTime = PyQt5.QtWidgets.QAction(
	...
	self.actionMidSpaceTime.triggered.connect(self.midSpaceTimeEvent)
	
	# ### about actions ###
	
	# About Qt
	self.actionAboutQt = PyQt5.QtWidgets.QAction(
	...
	# 	self.aboutQtEvent)
	self.actionAboutQt.triggered.connect(self.aboutQtEvent)

	# About Oroboros
	self.actionAboutOroboros = PyQt5.QtWidgets.QAction(
		QIcon(os.path.join(_iconsDir, 'gtk-about.png')),
	...
	self.actionAboutOroboros.triggered.connect(self.aboutOroborosEvent)
